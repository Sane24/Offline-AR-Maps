...
Live demo: **[sane24.github.io/Offline-AR-Maps](https://sane24.github.io/Offline-AR-Maps/)**
...
backcountry washes, and open desert (no signage, no landmarks, usually no signal), that
translation is exactly where people get lost.
...
the nav engine with the same constants. See [ios/README.md](ios/README.md) for details.
Planned next: MapLibre Native for the map tab, terrain-aware and elevation-aware routing costs,
and visual localization (on-device perception for re-anchoring when GPS is poor).
